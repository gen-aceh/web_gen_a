...
export function DataTableBerita<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div>
      <div className="flex items-center justify-between py-4">
        ...
        {/* Button Add */}
        <Button asChild>
          <Link href={`/dashboard/berita/add_berita`} className="capitalize">
            <FilePlus2 className="mr-2" /> Tambah Berita
          </Link>
        </Button>
      </div>
      ...
      <div className="relative mt-16">
        <Alert className="absolute -top-10 left-0 right-0 w-[95%] m-auto z-[5]">
          ...
          <AlertDescription>
            Berikut adalah List Berita milik <span className="font-bold">Gen A</span>
          </AlertDescription>
        </Alert>

...
export function DataTableUnggulan<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div>
      <div className="flex items-center justify-between py-4">
        ...
        {/* Button Add */}
        <Button asChild>
          <Link href={`/dashboard/unggulan/add_unggulan`} className="capitalize">
            <FilePlus2 className="mr-2" /> Tambah Unggulan
          </Link>
        </Button>
      </div>
      ...
      <div className="relative mt-16">
        <Alert className="absolute -top-10 left-0 right-0 w-[95%] m-auto z-[5]">
          ...
          <AlertDescription>
            Berikut List Kegiatan Unggulan <span className="font-bold">Gen A</span>
          </AlertDescription>
        </Alert>
